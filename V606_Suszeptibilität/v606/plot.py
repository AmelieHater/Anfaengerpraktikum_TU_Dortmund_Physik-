...
ax1.plot(x, y_norm, "x", label="Messwerte")
ax1.plot(x_2, Gauss(x_2, *params), label="Ausgleichskurve")
ax1.hlines(y =(1/np.sqrt(2)), xmin = 31.42, xmax = 31.85, linewidth = 2, linestyle = "-" , color = "green", label = "Güte")
ax1.set_xlabel(r"$f \, \left[ \text{kHz}\right]$")
ax1.set_ylabel(r"$\frac{U}{U_{\text{max}}}$")
ax1.legend(loc="best")
