...
print(f"K_beta Delta E: {Energie_K_beta1 - Energie_K_beta2}")
print ("----------------")
...
print(f"K_alpha Delta E {Energie_K_alpha1 - Energie_K_alpha2}")
# Abschirmkonstanten
...
theta_K_Sr_rel = rel_Abweichung(Theta_K_Sr_exp, 11.01)
theta_K_Zr_rel = rel_Abweichung(Theta_K_Zr_exp, 9.84)
theta_K_Br_rel = rel_Abweichung(Theta_K_Br_exp, 13.20)
theta_K_Zn_rel = rel_Abweichung(Theta_K_Zn_exp, 18.60)
theta_K_Ga_rel = rel_Abweichung(Theta_K_Ga_exp, 16.09)
...
E_Sr_rel = rel_Abweichung(energie_Sr_exp, 16.12*1000)
E_Zr_rel = rel_Abweichung(energie_Zr_exp, 18.01*1000)
E_Br_rel = rel_Abweichung(energie_Br_exp, 13.48*1000)
E_Zn_rel = rel_Abweichung(energie_Zn_exp, 9.65*1000)
E_Ga_rel = rel_Abweichung(energie_Ga_exp, 11.11*1000)
...
sigma_Sr_rel = rel_Abweichung(sigma_Sr_exp, 3.98)
sigma_Zr_rel = rel_Abweichung(sigma_Zr_exp, 4.08)
sigma_Br_rel = rel_Abweichung(sigma_Br_exp, 3.83)
sigma_Zn_rel = rel_Abweichung(sigma_Zn_exp, 3.56)
sigma_Ga_rel = rel_Abweichung(sigma_Ga_exp, 3.60)
