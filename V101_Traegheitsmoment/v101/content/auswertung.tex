...
\label{sec:Auswertung}
  ...
  \subsection{Trägheitsmoment der Puppe}
    \subsubsection{1. Position der Puppe}
      \textbf{Theoretischer Wert}\\
        ...
        \begin{table}[H]
          ...
          \begin{tblr}{colspec={c c c c}}
              \toprule
              Kopfvolumen $\,[10^{-5}\,\unit{\meter\tothe{3}}]$ & Armvolumen $\,[10^{-5}\,\unit{\meter\tothe{3}}]$ & Torsovolumen $\,[10^{-5}\,\unit{\meter\tothe{3}}]$ & Beinvolumen $\,[10^{-5}\,\unit{\meter\tothe{3}}]$\\
              \midrule 
              0,017 \pm 0,004 & 1,66 \pm 0,18 & 9.5 \pm 1,0 & 3,0 \pm 0,4 \\
              \bottomrule
          \end{tblr}
        \end{table}
      ...
      Die gemessenen fünffachen Periodendauer der Puppe in Position 1 sind in Tabelle (\ref{tab:T5_Position_1}) vermerkt, unterschieden nach Auslenkung um 90°
      und 120°. 
      \begin{table}[H]
        \centering 
