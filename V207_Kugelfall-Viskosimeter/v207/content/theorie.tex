...
\section{Theorie}
    ...
    darunter liegt auf eine laminare Strömung \cite{rz}. Die Reynoldszahl berechnet sich
    über 
    \begin{equation}
...
%
        \subsection{Kugelfall\,-\,Viskosimeter nach Höppler}
            ...
            Die leichte Neigung der Apparatur wird gewählt, um die unkontrollierte Bewegung zu vermeiden, 
    ...
    \FloatBarrier
        \subsection{Vorbereitungsaufgaben}
            ...
            \unit[per-mode=fraction]{\kilo\gram\per\meter\tothe{3}} \cite{dichte}.\\
