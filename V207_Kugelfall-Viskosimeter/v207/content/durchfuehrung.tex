...
Apperaturkonstante für die kleine Kugel $K_{kl}$ %= 0.07640 \unit[per-mode=fraction]{\milli\pascal\per\cubic\centi\meter}$ 
verwendet. \\
...
gewartet werden, damit sich die Temperatur des destillierten Wassers im Inneren der Temperatur des umliegenden 
Wassers angleicht. \\
